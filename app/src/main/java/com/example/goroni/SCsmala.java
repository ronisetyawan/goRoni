...
public class SCsmala extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String lokasirs = "https://maps.app.goo.gl/TVGegmv4cUXEJtsr7";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasirs));

            } else if (pilihan.equals("Website")) {
                String website = "https://www.sman5pekanbaru.sch.id/halaman/home";
